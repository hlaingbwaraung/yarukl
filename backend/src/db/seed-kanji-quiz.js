...
async function seedKanjiQuiz() {
  try {
    ...
    // =====================================================
    const n5Grammar = [
      [`「わたし ___ がくせいです。」（　）に入る正しいものはどれですか。`, `を`, `に`, `は`, `で`, `C`, `は is the topic marker particle. "I am a student." မြန်မာလို - ကျွန်တော်/ကျွန်မ ကျောင်းသားပါ။`],
      [`「すしを たべます。」正しい文はどれですか。`, `すしを たべます`, `すしは たべます`, `すしに たべます`, `すしで たべます`, `A`, `を marks the direct object of an action verb. မြန်မာလို - ဆူရှီ စားပါတယ်။`],
      [`「がっこう ___ いきます。」（　）に入る正しいものはどれですか。`, `を`, `に`, `は`, `で`, `B`, `に indicates direction/destination with movement verbs. မြန်မာလို - ကျောင်းသွားပါတယ်။`],
      [`「でんしゃ ___ いきます。」（　）に入る正しいものはどれですか。`, `を`, `に`, `は`, `で`, `D`, `で marks the means/method of transport. မြန်မာလို - ရထားနဲ့ သွားပါတယ်။`],
      [`「たべます」の否定形はどれですか。`, `たべます`, `たべません`, `たべました`, `たべましょう`, `B`, `～ません is the negative present polite form. မြန်မာလို - မစားပါဘူး။`],
      [`「たべます」の過去形はどれですか。`, `たべます`, `たべません`, `たべました`, `たべましょう`, `C`, `～ました is the past polite form. မြန်မာလို - စားခဲ့ပါတယ်။`],
      [`「きのう なにを ___か。」（　）に入る正しいものはどれですか。`, `します`, `しました`, `しません`, `していません`, `B`, `Past tense question: "What did you do yesterday?" မြန်မာလို - မနေ့က ဘာလုပ်ခဲ့ပါသလဲ။`],
      [`「ねこが ___。」（　）に入る正しいものはどれですか。`, `います`, `あります`, `です`, `なります`, `A`, `います is for living things (people, animals). မြန်မာလို - ကြောင်ရှိပါတယ်။`],
      [`「ほんが ___。」（　）に入る正しいものはどれですか。`, `います`, `あります`, `です`, `なります`, `B`, `あります is for non-living things. မြန်မာလို - စာအုပ်ရှိပါတယ်။`],
      [`「この りんご ___ おいしいです。」（　）に入る正しいものはどれですか。`, `が`, `を`, `に`, `で`, `A`, `が marks the subject with adjective predicates. မြန်မာလို - ဒီပန်းသီး အရသာကောင်းပါတယ်။`],
      [`「いっしょに食べよう」のていねいな言い方はどれですか。`, `たべます`, `たべません`, `たべました`, `たべましょう`, `D`, `～ましょう is the "let's do ~" suggestion form. မြန်မာလို - စားကြရအောင်။`],
      [`「ミラーさん ___ アメリカ人です。」（　）に入る正しいものはどれですか。`, `が`, `は`, `を`, `に`, `B`, `は introduces the topic of the sentence. မြန်မာလို - မီလာဆန်ဟာ အမေရိကန်ပါ။`],
      [`「はしらないで」のていねいなお願いの形はどれですか。`, `はしります`, `はしってください`, `はしらないでください`, `はしりましょう`, `C`, `～ないでください is the polite negative request form. မြန်မာလို - မပြေးပါနှင့်။`],
      [`「のむ」のて形はどれですか。`, `のんで`, `のみて`, `のって`, `のして`, `A`, `のむ → のんで (む→んで pattern). မြန်မာလို - သောက်ပြီး...`],
      [`「すわる」のお願いの形はどれですか。`, `すわります`, `すわってください`, `すわりません`, `すわりましょう`, `B`, `～てください is the polite request form. မြန်မာလို - ထိုင်ပါ။`],
    ];
    ...
    // =====================================================
    const n4Grammar = [
      [`「書く」の正しいて形はどれですか。`, `書いて`, `書って`, `書きて`, `書して`, `A`, `書く → 書いて (く→いて pattern). မြန်မာလို - ရေးပြီးတော့...`],
      [`「雨が ふって___、さんぽに いきませんでした。」（　）に入る正しいものはどれですか。`, `いたから`, `いるので`, `いたので`, `いますから`, `C`, `〜ていたので expresses reason in past progressive. မြန်မာလို - မိုးရွာနေလို့ လမ်းမလျှောက်ဖြစ်ခဲ့ပါ`],
      [`「日本語が話せる」の正しい文はどれですか。`, `にほんごを はなします`, `にほんごが はなせます`, `にほんごを はなしたい`, `にほんごに はなします`, `B`, `〜が + potential form expresses ability. မြန်မာလို - ဂျပန်စကား ပြောတတ်ပါတယ်`],
      [`「飲む」の正しいて形はどれですか。`, `飲んで`, `飲みて`, `飲って`, `飲して`, `A`, `飲む → 飲んで (む→んで pattern). မြန်မာလို - သောက်ပြီး...`],
      [`「待つ」の正しいて形はどれですか。`, `待いて`, `待って`, `待ちて`, `待して`, `B`, `待つ → 待って (つ→って pattern). မြန်မာလို - စောင့်ပြီး...`],
      [`「たなかさんは いま ごはんを ___います。」（　）に入る正しいものはどれですか。`, `たべる`, `たべて`, `たべた`, `たべ`, `B`, `〜ています expresses ongoing action. "Tanaka is eating now." မြန်မာလို - တနာကာ ယခု ထမင်းစားနေပါသည်`],
      [`「日本に行きたい」のていねい形はどれですか。`, `にほんに いきます`, `にほんに いきたいです`, `にほんに いきました`, `にほんに いきません`, `B`, `〜たいです expresses desire. မြန်မာလို - ဂျပန်သွားချင်ပါတယ်`],
      [`「まど ___ あけてください。」（　）に入る正しいものはどれですか。`, `が`, `を`, `に`, `で`, `B`, `を marks the object of the action あける (to open). မြန်မာလို - ပြတင်းပေါက်ကို ဖွင့်ပေးပါ`],
      [`「勉強しなければならない」のていねい形はどれですか。`, `べんきょうしなくてもいいです`, `べんきょうしなければなりません`, `べんきょうしてもいいです`, `べんきょうしたいです`, `B`, `〜なければなりません means "must do ~". မြန်မာလို - စာကျက်ရမည်`],
      [`「写真を撮ってもいいか」のていねいな言い方はどれですか。`, `しゃしんを とります`, `しゃしんを とってもいいですか`, `しゃしんを とりません`, `しゃしんを とらなければなりません`, `B`, `〜てもいいですか asks for permission. မြန်မာလို - ဓာတ်ပုံ ရိုက်လို့ ရပါသလား`],
      [`「びょうきの とき、くすりを ___。」（　）に入る正しいものはどれですか。`, `のみます`, `のんでいます`, `のんだことがあります`, `のまないでください`, `A`, `〜のとき describes a conditional time. မြန်မာလို - ဖျားတဲ့အခါ ဆေးသောက်ပါတယ်`],
      [`「京都に行ったことがある」のていねい形はどれですか。`, `きょうとに いきます`, `きょうとに いきたいです`, `きょうとに いったことがあります`, `きょうとに いってください`, `C`, `〜たことがあります expresses past experience. မြန်မာလို - ကျိုတိုကို သွားဖူးပါတယ်`],
      [`「テレビを みた ___ ねました。」（　）に入る正しいものはどれですか。`, `あとで`, `まえに`, `あいだに`, `ながら`, `A`, `〜あとで means "after doing ~". မြန်မာလို - TV ကြည့်ပြီးတော့ အိပ်ခဲ့ပါတယ်`],
      [`「ごはんを たべる ___ てを あらいます。」（　）に入る正しいものはどれですか。`, `あとで`, `まえに`, `とき`, `ながら`, `B`, `〜まえに means "before doing ~". မြန်မာလို - ထမင်းမစားခင် လက်ဆေးပါတယ်`],
      [`「高くなった」のていねい形はどれですか。`, `たかいです`, `たかくなりました`, `たかかったです`, `たかくないです`, `B`, `い-adj → 〜くなりました means "became ~". မြန်မာလို - ဈေးကြီးလာခဲ့ပါတယ်`],
      [`「おんがくを ___ながら べんきょうします。」（　）に入る正しいものはどれですか。`, `きく`, `きいて`, `きき`, `きいた`, `C`, `〜ながら (stem+ながら) = while doing. မြန်မာလို - ဂီတနားထောင်ရင်း စာကျက်ပါတယ်`],
      [`「雨が降ったら」の条件の形として正しいものはどれですか。`, `あめが ふると`, `あめが ふって`, `あめが ふったから`, `あめが ふりますが`, `A`, `〜と expresses a natural/automatic condition. မြန်မာလို - မိုးရွာရင်...`],
      [`「おいしい」の様態を表す正しい形はどれですか。`, `おいしいです`, `おいしかったです`, `おいしそうです`, `おいしくないです`, `C`, `〜そうです (stem+そう) expresses appearance. မြန်မာလို - အရသာကောင်းပုံပဲ`],
      [`「にほんごが ___ なりました。」（　）に入る正しいものはどれですか。`, `じょうずに`, `じょうずく`, `じょうずで`, `じょうずな`, `A`, `な-adj → 〜になりました means "became ~". မြန်မာလို - ဂျပန်စကား ကျွမ်းကျင်လာပါပြီ`],
      [`「雨が降る」と思うとき、正しい言い方はどれですか。`, `あめが ふると おもいます`, `あめが ふっています`, `あめが ふりました`, `あめが ふってください`, `A`, `〜とおもいます expresses opinion. မြန်မာလို - မိုးရွာမယ်ထင်ပါတယ်`],
    ];
    ...
    // =====================================================
    const n3Grammar = [
      [`「この問題は 難しすぎて、___。」（　）に入る正しいものはどれですか。`, `できました`, `できません`, `できます`, `できるでしょう`, `B`, `〜すぎて implies excessive degree leading to negative result. မြန်မာလို - ဒီပြဿနာက ခက်လွန်းလို့ မလုပ်နိုင်ပါ`],
      [`「〜ようにする」の正しい使い方はどれですか。`, `毎日 運動する ようにしています`, `毎日 運動した ようにしています`, `毎日 運動の ようにしています`, `毎日 運動 ようにしています`, `A`, `〜ようにする means "to make an effort to do". မြန်မာလို - နေ့တိုင်း လေ့ကျင့်ခန်းလုပ်အောင် ကြိုးစားနေပါတယ်`],
      [`「ニュースの情報では」と同じ意味の表現はどれですか。`, `ニュースによると`, `ニュースについて`, `ニュースに対して`, `ニュースにとって`, `A`, `〜によると means "according to". မြန်မာလို - သတင်းအရ`],
      [`「___ば、じょうずに なります。」（　）に入る正しいものはどれですか。`, `れんしゅうすれ`, `れんしゅうして`, `れんしゅうする`, `れんしゅうした`, `A`, `〜ば is the conditional form. "If you practice, you'll improve." မြန်မာလို - လေ့ကျင့်ရင် ကျွမ်းကျင်လာပါမယ်`],
      [`「日本に 来て___、もう 2年に なります。」（　）に入る正しいものはどれですか。`, `から`, `まで`, `ので`, `のに`, `A`, `〜てから means "since doing ~". မြန်မာလို - ဂျပန်ရောက်ကတည်းက နှစ်နှစ်ရှိပြီ`],
      [`「雨が降りそうだ」と同じ意味の表現はどれですか。`, `あめが ふるらしいです`, `あめが ふるそうです`, `あめが ふるようです`, `全て正しい`, `D`, `らしい, そう(伝聞), よう all express "it seems". Each has slight nuance differences. မြန်မာလို - မိုးရွာမယ်ပုံပဲ`],
      [`「せんせいに ___ました。」（　）に入る正しいものはどれですか。`, `ほめて`, `ほめられ`, `ほめさせ`, `ほめる`, `B`, `〜られました is the passive form. "I was praised by the teacher." မြန်မာလို - ဆရာဆီက ချီးကျူးခံရပါတယ်`],
      [`「子どもに勉強させた」のていねい形はどれですか。`, `こどもが べんきょうしました`, `こどもに べんきょうさせました`, `こどもは べんきょうしています`, `こどもを べんきょうしました`, `B`, `〜させました is the causative form. မြန်မာလို - ကလေးကို စာကျက်ခိုင်းခဲ့ပါတယ်`],
      [`「でんきを つけた___、へやを でました。」（　）に入る正しいものはどれですか。`, `まま`, `ところ`, `ばかり`, `はず`, `A`, `〜たまま means "leaving something as is". မြန်မာလို - မီးဖွင့်ထားလျက် အခန်းကထွက်ခဲ့ပါတယ်`],
      [`「いま ごはんを たべた ___です。」（　）に入る正しいものはどれですか。`, `まま`, `ところ`, `ばかり`, `はず`, `C`, `〜たばかりです means "just did ~". မြန်မာလို - ယခုမှ ထမင်းစားပြီးချင်းပဲ`],
      [`「来る予定だ」と同じ意味の表現はどれですか。`, `くるところです`, `くるはずです`, `くるばかりです`, `くるままです`, `B`, `〜はずです means "supposed to / expected to". မြန်မာလို - လာရမှာပါ`],
      [`「かのじょは うれしくて、ない___。」（　）に入る正しいものはどれですか。`, `そうです`, `みたいです`, `ようです`, `らしいです`, `A`, `〜(ない)そうです = "looks like (won't cry)". Based on speaker's direct observation. မြန်မာလို - ပျော်လွန်းလို့ မငိုဟန်ပဲ`],
      [`「にほんごの じょうずな ___、えいごも できます。」（　）に入る正しいものはどれですか。`, `だけでなく`, `ために`, `おかげで`, `せいで`, `A`, `〜だけでなく means "not only ~ but also". မြန်မာလို - ဂျပန်စကား ကျွမ်းရုံမက အင်္ဂလိပ်စကားလည်း ပြောတတ်ပါတယ်`],
      [`「友達の ___で、しごとが みつかりました。」（　）に入る正しいものはどれですか。`, `おかげ`, `せい`, `ため`, `わけ`, `A`, `〜のおかげで means "thanks to ~" (positive cause). မြန်မာလို - သူငယ်ချင်းကြောင့် အလုပ်ရခဲ့ပါတယ်`],
      [`「電車が おくれた ___で、ちこくしました。」（　）に入る正しいものはどれですか。`, `おかげ`, `せい`, `ため`, `わけ`, `B`, `〜のせいで means "because of ~" (negative cause). မြန်မာလို - ရထားနောက်ကျလို့ စာအတန်းနောက်ကျခဲ့ပါတယ်`],
      [`「試験に受かるために」と同じ意味の表現はどれですか。`, `しけんに うかるように`, `しけんに うかるために`, `両方正しい`, `どちらも正しくない`, `C`, `〜ように and 〜ために both express purpose. ように is for potential/intransitive verbs. မြန်မာလို - စာမေးပွဲအောင်ဖို့`],
      [`「この本は 子ども___ 書かれた 本です。」（　）に入る正しいものはどれですか。`, `ために`, `のために`, `ように`, `として`, `B`, `〜のために means "for the sake of ~". မြန်မာလို - ဒီစာအုပ်က ကလေးများအတွက် ရေးသားထားတဲ့ စာအုပ်ပါ`],
      [`「あの人は 日本人___話します。」（　）に入る正しいものはどれですか。`, `ように`, `みたいに`, `らしく`, `全て正しい`, `D`, `〜のように / みたいに / らしく all mean "like a ~". မြန်မာလို - ထိုသူက ဂျပန်လူလို ပြောပါတယ်`],
      [`「行くか行かないか」を一つの表現で言うとき、正しいものはどれですか。`, `かどうか`, `かもしれない`, `にちがいない`, `にくい`, `A`, `〜かどうか means "whether or not". မြန်မာလို - ဟုတ်မဟုတ်`],
      [`「あした 雨が ふる___。」（　）に入る正しいものはどれですか。`, `かもしれません`, `にちがいありません`, `はずです`, `わけです`, `A`, `〜かもしれません means "might ~". မြန်မာလို - မနက်ဖြန် မိုးရွာနိုင်ပါတယ်`],
    ];
    ...
    // =====================================================
    const n2Grammar = [
      [`「この本は 大人___、子どもにも 読みやすい。」（　）に入る正しいものはどれですか。`, `だけでなく`, `ばかりか`, `に限らず`, `全て正しい`, `D`, `All three express "not only A but also B". မြန်မာလို - ဒီစာအုပ်က လူကြီးတွေသာမက ကလေးတွေအတွက်လည်း ဖတ်ရလွယ်ပါတယ်`],
      [`「〜している間は」と同じ意味の文法はどれですか。`, `〜限り`, `〜次第`, `〜際に`, `〜上で`, `A`, `〜限り(かぎり) means "as long as". မြန်မာလို - ...သရွေ့`],
      [`「試験に 合格した ___、就職が 決まった。」（　）に入る正しいものはどれですか。`, `おかげで`, `せいで`, `くせに`, `わりに`, `A`, `〜おかげで indicates positive cause. မြန်မာလို - စာမေးပွဲ အောင်တဲ့ ကျေးဇူးနဲ့ အလုပ်ရခဲ့ပါတယ်`],
      [`「日本語が 下手な ___、よく 話します。」（　）に入る正しいものはどれですか。`, `おかげで`, `せいで`, `くせに`, `わりに`, `C`, `〜くせに means "even though" (critical nuance). မြန်မာလို - ဂျပန်စကား ညံ့ပါတဲ့နဲ့ အများကြီး ပြောပါတယ်`],
      [`「〜によって変わる」と同じ意味の文法はどれですか。`, `〜次第`, `〜に関して`, `〜について`, `〜に対して`, `A`, `〜次第(しだい) means "depending on". မြန်မာလို - ...အပေါ်မူတည်ပြီး`],
      [`「問題が ___次第、連絡します。」（　）に入る正しいものはどれですか。`, `解決する`, `解決した`, `解決し`, `解決して`, `C`, `(Verb stem)＋次第 means "as soon as". မြန်မာလို - ပြဿနာ ဖြေရှင်းပြီးတာနဲ့ ဆက်သွယ်ပါမယ်`],
      [`「〜のことについて」と同じ意味の表現はどれですか。`, `〜に対して`, `〜に関して`, `〜について`, `BとCの両方`, `D`, `〜に関して and 〜について both mean "regarding/about". မြန်မာလို - ...နှင့်ပတ်သက်၍`],
      [`「彼は 学生___、会社も 経営している。」（　）に入る正しいものはどれですか。`, `でありながら`, `にもかかわらず`, `であるくせに`, `AとBの両方`, `D`, `Both express "despite being a student". မြန်မာလို - ကျောင်းသားဖြစ်ပါတဲ့နဲ့ ကုမ္ပဏီလည်း အုပ်ချုပ်ပါတယ်`],
      [`「その結果」と同じ意味の表現はどれですか。`, `その結果`, `したがって`, `そのため`, `全て正しい`, `D`, `All three can express "as a result" or "therefore". မြန်မာလို - ထို့ကြောင့်`],
      [`「忙しい___、旅行に 行きたいです。」（　）に入る正しいものはどれですか。`, `としても`, `にしても`, `ものの`, `AとBの両方`, `D`, `〜としても/〜にしても both mean "even if". မြန်မာလို - အလုပ်များပေမယ့် ခရီးသွားချင်ပါတယ်`],
      [`「日本に 来た ___は、日本語が 全然 分かりませんでした。」（　）に入る正しいものはどれですか。`, `ばかり`, `ところ`, `ころ/とき`, `はず`, `C`, `〜ころ/とき means "when/around the time". မြန်မာလို - ဂျပန်ရောက်ကစက ဂျပန်စာ လုံးဝနားမလည်ခဲ့ပါ`],
      [`「必ずしもそうではない」と同じ意味の文法はどれですか。`, `〜わけではない`, `〜はずがない`, `〜ことはない`, `〜べきではない`, `A`, `〜わけではない means "it doesn't mean that...". မြန်မာလို - ...ဆိုတာ မဟုတ်ပါ`],
      [`「薬を 飲んだ ___、まだ 頭が 痛いです。」（　）に入る正しいものはどれですか。`, `のに`, `ので`, `から`, `ために`, `A`, `〜のに expresses frustration - "even though". မြန်မာလို - ဆေးသောက်ပေမယ့် ခေါင်းကိုက်နေသေးတယ်`],
      [`「〜した方がいい」と同じ意味の文法はどれですか。`, `〜べきです`, `〜ことです`, `〜ものです`, `〜わけです`, `A`, `〜べきです means "should/ought to". မြန်မာလို - ...သင့်ပါတယ်`],
      [`「この仕事は 3人___では 終わらない。」（　）に入る正しいものはどれですか。`, `だけ`, `ばかり`, `しか`, `ほど`, `A`, `〜だけでは means "just with/only with". မြန်မာလို - ဒီအလုပ် ၃ယောက်တည်းနဲ့ မပြီးနိုင်ပါ`],
    ];
    ...
    // =====================================================
    const n1Grammar = [
      [`「彼は 医者で___、研究者でもある。」（　）に入る正しいものはどれですか。`, `あるとともに`, `ありながら`, `あると同時に`, `全て正しい`, `D`, `All express "as well as being". မြန်မာလို - သူက ဆရာဝန်အဖြစ်သာမက သုတေသီလည်း ဖြစ်ပါတယ်`],
      [`「〜の程度まで」と同じ意味の表現はどれですか。`, `〜ほど`, `〜くらい`, `〜だけ`, `AとBの両方`, `D`, `〜ほど and 〜くらい both express degree. မြန်မာလို - ...လောက်ထိ`],
      [`「努力した ___、成功した。」（　）に入る正しいものはどれですか。`, `からこそ`, `からには`, `からして`, `からといって`, `A`, `〜からこそ means "precisely because". မြန်မာလို - ကြိုးစားခဲ့လို့သာလျှင် အောင်မြင်ခဲ့တာပါ`],
      [`「約束した ___、守らなければならない。」（　）に入る正しいものはどれですか。`, `からこそ`, `からには`, `からして`, `からといって`, `B`, `〜からには means "now that/since". မြန်မာလို - ကတိပေးခဲ့တာကိုးတည် တည်ရမည်`],
      [`「必ずしも〜ではない」と同じ意味の文法はどれですか。`, `〜とは限らない`, `〜わけがない`, `〜はずがない`, `〜ことはない`, `A`, `〜とは限らない means "not necessarily". မြန်မာလို - ...ဟူ၍ မဟုတ်ချေ`],
      [`「どんなに 忙しく___、健康は 大切だ。」（　）に入る正しいものはどれですか。`, `ても`, `ては`, `ないと`, `なくては`, `A`, `〜ても means "even if/no matter how". မြန်မာလို - ဘယ်လောက်ပဲ အလုပ်များများ ကျန်းမာရေးက အရေးကြီးပါတယ်`],
      [`「まるで〜のようだ」と同じ意味の表現はどれですか。`, `〜かのようだ`, `〜みたいだ`, `〜らしい`, `全て正しい`, `D`, `All express appearance/seeming, with different formality levels. မြန်မာလို - ...ကဲ့သို့ / ...ပုံပဲ`],
      [`「結果は ___にせよ、全力を 尽くそう。」（　）に入る正しいものはどれですか。`, `どう`, `なに`, `いつ`, `どこ`, `A`, `〜にせよ means "regardless of". မြန်မာလို - ရလဒ် ဘယ်လိုပဲ ဖြစ်ဖြစ် အားကုန်ထုတ်ကြစို့`],
      [`「〜しないで」と同じ意味の表現はどれですか。`, `〜ないで`, `〜ずに`, `〜ことなく`, `全て正しい`, `D`, `All three express "without doing ~". 〜ことなく is most formal. မြန်မာလို - ...မလုပ်ဘဲ`],
      [`「時間が ない ___、急ぎましょう。」（　）に入る正しいものはどれですか。`, `以上`, `上は`, `からには`, `全て正しい`, `D`, `〜以上/〜上は/〜からには all mean "since/given that". မြန်မာလို - အချိန်မရှိသင့်ဘာ့ အမြန်လုပ်ကြပါစို့`],
      [`「彼の 態度は 許す ___。」（　）に入る正しいものはどれですか。`, `べきだ`, `べきではない`, `べからず`, `べからざる`, `C`, `〜べからず is classical "must not / should not". မြန်မာလို - သူ့ သဘောထားကို ခွင့်လွှတ်နိုင်ဖွယ် မရှိပါ`],
      [`「予想通り」と同じ意味の表現はどれですか。`, `やはり`, `さすが`, `まさか`, `AとBの両方`, `D`, `やはり and さすが both can mean "as expected" with different nuances. မြန်မာလို - မျှော်လင့်ထားတဲ့ အတိုင်းပဲ`],
      [`「合格___不合格___、連絡します。」（　）に入る正しいものはどれですか。`, `であれ/であれ`, `にせよ/にせよ`, `にしろ/にしろ`, `全て正しい`, `D`, `All patterns mean "whether A or B". မြန်မာလို - အောင်ဖြစ်ဖြစ် ကျဖြစ်ဖြစ် ဆက်သွယ်ပါမယ်`],
      [`「この映画は 見れば 見る___、面白くなる。」（　）に入る正しいものはどれですか。`, `ほど`, `だけ`, `ばかり`, `まで`, `A`, `〜ば〜ほど means "the more...the more". မြန်မာလို - ကြည့်ရင်ကြည့်လေ ပိုစိတ်ဝင်စားလေပါ`],
      [`「言わなくてもわかる」と同じ意味の表現はどれですか。`, `言うまでもない`, `言わざるを得ない`, `言いようがない`, `言うべきだ`, `A`, `言うまでもない means "it goes without saying". မြန်မာလို - ပြောစရာမလိုပါ`],
    ];
